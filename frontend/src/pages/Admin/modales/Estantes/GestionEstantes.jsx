...
export default function GestionEstantes({ bodegaId }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (estado) => {
        const colores = {
          Disponible: "#52c41a", // verde — con espacio libre
          Completo: "#fa8c16", // naranja — sin espacio disponible
          Inhabilitado: "#ff4d4f", // rojo — fuera de uso
          Mantenimiento: "#faad14", // amarillo — en reparación
        };
        return (
          <span
            style={{
              color: colores[estado] || "#8c8c8c",
              fontSize: "12px",
              fontWeight: 600,
            }}
          >
